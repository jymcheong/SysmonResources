...
If you have the luxury using cool **E**ndpoint **D**etection & **R**esponse platform, good for you. But if one doesn't even know what the heck is EDR (***nothing wrong with that!***) & wants to start somewhere, Sysmon is that free resource that you may be looking for. 
