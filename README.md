...
My opinions/thoughts/contributions are largely within the [visualization](https://github.com/jymcheong/SysmonViz) & [sample data folders](https://github.com/jymcheong/SysmonResources/tree/master/6.%20Sample%20Data) (sample logs will be gradually added). [Github Desktop](https://desktop.github.com) & [Typora](https://typora.io) apps made it a pleasure to organise these resources.
